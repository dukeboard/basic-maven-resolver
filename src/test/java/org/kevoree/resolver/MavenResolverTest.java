...
public class MavenResolverTest {
    ...
    public void testCentralAndLocalResolution() {
        ...
        File resolved3 = resolver.resolve("io.tesla.maven", "maven-model", "3.1.2", "jar", l2);
        System.out.println(resolved3);
    ...
    public void testRemoteResolution() {
        ...
        File resolved2 = resolver.resolve("org.kevoree.corelibrary.model", "org.kevoree.library.model.bootstrap", "latest", "jar", l);
        System.out.println(resolved2);
    ...
    @Test
    public void testRemoteResolution5() {
        MavenResolver resolver = new MavenResolver();
        HashSet<String> l = new HashSet<String>();
        l.add("http://oss.sonatype.org/content/groups/public");
        File resolved = resolver.resolve("org.kevoree.library.java", "org.kevoree.library.java.javaNode", "latest", "jar", l);
        System.out.println(resolved.getAbsolutePath());
        Assert.assertNotSame(null, resolved);
    }

    @Test
    public void testRemoteResolution6() {
        MavenResolver resolver = new MavenResolver();
        HashSet<String> l = new HashSet<String>();
        l.add("https://oss.sonatype.org/content/groups/public");
        File resolved = resolver.resolve("mvn:org.kevoree.library.java:org.kevoree.library.java.javaNode:latest", l);
        System.out.println(resolved.getAbsolutePath());
        Assert.assertNotSame(null, resolved);
    }
